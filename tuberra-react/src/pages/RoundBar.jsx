          ...
          >
            <div>
              ...
              <div className="text-silver leading-relaxed">
                <span className="block mt-1">We supply a wide range of high-quality round bars manufactured to international standards, offering excellent strength, durability, corrosion resistance, and machinability. Our round bars are suitable for critical engineering, structural, and industrial applications across multiple sectors.</span>
                <span className="block mt-1">Available in a variety of materials and finishes, our bars ensure consistent performance in demanding environments.</span>
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-silver">
                <ul className="text-silver space-y-1 list-none pl-0">
                  ...
                  <li>Diameter Range: 5mm to 500mm</li>
                  <li>Length: 3m / 6m / Custom Cut Length</li>
                  <li>Form: Round</li>
                  <li>Finish: Black / Bright / Polished / Rough Turned / Peeled</li>
                  <li>Tolerance: H8 / H9 / As per requirement</li>
                  <li>Heat Treatment: Annealed / Normalized / Quenched & Tempere</li>
                </ul>
              </div>
            </div>
            <div>
              ...
              <div className="text-silver">
                <span className="text-white font-semibold block mt-4 mb-2">Stainless Steel (ASTM A276 / A479)</span>
                ...
                <span className="block mt-1">Carbon Steel (ASTM A36 / A105 / A108)</span>
                <span className="block mt-1">ASTM A36</span>
                <span className="block mt-1">EN8 / C45</span>
                <span className="block mt-1">SAE 1018 / 1020 / 1045</span>
                <span className="text-white font-semibold block mt-4 mb-2">Alloy Steel (Chrome-Moly)</span>
                <span className="block mt-1">(ASTM A182 / A29)</span>
                <span className="block mt-1">EN19</span>
                <span className="block mt-1">EN24</span>
                <span className="block mt-1">EN41</span>
                <span className="block mt-1">EN353</span>
                <span className="block mt-1">AISI 4130</span>
                <span className="block mt-1">AISI 4140</span>
                <span className="block mt-1">AISI 4340</span>
                <span className="text-white font-semibold block mt-4 mb-2">Duplex & Super Duplex (ASTM A276)</span>
                <span className="block mt-1">Duplex 2205 (S31803 / S32205)</span>
                <span className="block mt-1">Super Duplex 2507 (S32750)</span>
                <span className="text-white font-semibold block mt-4 mb-2">Nickel & Special Alloys</span>
                <span className="block mt-1">(ASTM B160 / B164 / B574)</span>
                ...
                <span className="block mt-1">Titanium (ASTM B348)  Grade 2, Grade 5</span>
                <span className="text-white font-semibold block mt-4 mb-2">Cupronickel  (ASTM B151 )</span>
                <span className="block mt-1">90/10, 70/30</span>
              </div>
            </div>
            <div>
