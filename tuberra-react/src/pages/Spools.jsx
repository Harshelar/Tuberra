    ...
    <section className="py-24 px-6 lg:px-20 relative bg-[#060a16] min-h-screen">
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <img 
              src="https://dinmanipipefittings.com/images/dinmanipipefittings/product/prod/spool-manufacture-india.jpg"
              alt="Spools"
            ...
            <div>
              ...
              <div className="text-silver">
                <ul className="text-silver space-y-1 list-none pl-0">
                  <li>Cut-to-length Pipes</li>
                  <li>Welded Assemblies</li>
                  <li>Flanged Spools</li>
                  <li>Valves & Fittings Integration</li>
                  <li>Pre-fabricated Modules</li>
                </ul>
              </div>
            </div>
            <div>
              ...
              <div className="text-silver">
                <ul className="text-silver space-y-1 list-none pl-0">
                  <li>Standards: ASME B31.3, B31.1</li>
                  <li>Size Range: As per project requirement</li>
                  <li>Fabrication: Shop-fabricated / Site-ready</li>
                  <li>Testing: Hydrotest, Radiography, PMI, NDT</li>
                  <li>Surface Treatment: Painting, Coating, Galvanizing</li>
                </ul>
              </div>
            </div>
            <div>
