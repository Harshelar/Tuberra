          ...
          >
            <div>
              ...
              <div className="text-silver leading-relaxed">
                <span className="block mt-1">Olets are precision-engineered branch connection fittings used to connect pipelines at various angles. They ensure smooth flow transition and high structural integrity in piping systems.</span>
              </div>
            </div>
            <div>
