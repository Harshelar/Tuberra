        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div>
              ...
              <div className="text-silver">
                <span className="text-white font-semibold block mt-3 mb-1">Stainless Steel</span>
                ...
                <span className="text-white font-semibold block mt-3 mb-1">Carbon Steel</span>
                ...
                <span className="text-white font-semibold block mt-3 mb-1">Alloy Steel (Chrome-Moly)</span>
                <span className="block mt-1">ASTM A335 P5, P9, P11, P22, P91, P92</span>
                <span className="block mt-1">ASTM A213 T5, T9, T11, T22, T91</span>
                
                <span className="text-white font-semibold block mt-3 mb-1">Nickel & Special Alloys</span>
