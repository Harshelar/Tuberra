        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div>
              ...
              <div className="text-silver">
                <ul className="text-silver space-y-1 list-none pl-0">
                  <li>Size Range: 1/16” to 2”</li>
                  <li>Pressure Rating: Up to 10,000 PSI</li>
                  <li>Connection Type: Tube / Threaded</li>
                  <li>Standards: ASTM / ASME</li>
                </ul>
              </div>
            </div>
            <div>
