    ...
    <section id="products" className="py-24 px-6 lg:px-20 relative bg-[#060a16]">
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="font-bebas text-[clamp(2.5rem,4vw,3.8rem)] tracking-[0.05em] text-white leading-[1.05] mb-6 drop-shadow-lg">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {productsData.map((product, index) => (
            <motion.div
              ...
              className="glass-panel glass-panel-hover overflow-hidden relative group rounded-xl cursor-pointer"
            >
